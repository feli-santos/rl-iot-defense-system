...
class TestAttackSequenceGeneratorForward:
    ...
    def test_forward_different_sequence_lengths(self, model: AttackSequenceGenerator) -> None:
...
class TestAttackSequenceGeneratorInference:
    ...
    def test_predict_next_returns_distribution(self, model: AttackSequenceGenerator) -> None:
    ...
    def test_sample_next_returns_valid_stage(self, model: AttackSequenceGenerator) -> None:
    ...
    def test_sample_next_is_stochastic(self, model: AttackSequenceGenerator) -> None:
    ...
    def test_temperature_affects_sampling(self, model: AttackSequenceGenerator) -> None:
        """Higher temperature should increase randomness."""
        history = [0, 1, 2, 3]

        # Low temperature (more deterministic)
        samples_low = [model.sample_next(history, temperature=0.1) for _ in range(50)]

        # High temperature (more random)
        samples_high = [model.sample_next(history, temperature=2.0) for _ in range(50)]
    ...
    def test_generate_sequence_returns_list(self, model: AttackSequenceGenerator) -> None:
    ...
    def test_generate_sequence_starts_with_history(self, model: AttackSequenceGenerator) -> None:
...
class TestAttackSequenceGeneratorSaveLoad:
    ...
    def test_save_model(self, model: AttackSequenceGenerator, temp_generator_dir: Path) -> None:
    ...
    def test_load_model(self, model: AttackSequenceGenerator, temp_generator_dir: Path) -> None:
...
class TestAttackSequenceGeneratorGradients:
    ...
    def test_parameters_are_trainable(self, model: AttackSequenceGenerator) -> None:
