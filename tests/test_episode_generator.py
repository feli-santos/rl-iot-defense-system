...
class TestEpisodeGeneratorSingleEpisode:
    ...
    def test_generate_episode_returns_list(self, generator: EpisodeGenerator) -> None:
    ...
    def test_episode_length_within_bounds(self, generator: EpisodeGenerator) -> None:
    ...
    def test_episode_starts_with_benign(self, generator: EpisodeGenerator) -> None:
    ...
    def test_episode_values_in_valid_range(self, generator: EpisodeGenerator) -> None:
        """All stages should be 0-4."""
        episode = generator.generate_episode()

        assert all(0 <= s <= 4 for s in episode)

    def test_no_self_reset_to_benign(self, generator: EpisodeGenerator) -> None:
        ...
        for _ in range(50):
            ...
            for stage in episode:
                if stage > 0:
                    ...
                    pytest.fail(f"Episode reset to BENIGN after attack: {episode}")
...
class TestEpisodeGeneratorBatch:
    ...
    def test_generate_batch_returns_list(self, generator: EpisodeGenerator) -> None:
    ...
    def test_generate_all_episodes(self, generator: EpisodeGenerator) -> None:
    ...
    def test_batch_diversity(self, generator: EpisodeGenerator) -> None:
        ...
        unique_episodes = {tuple(ep) for ep in episodes}
...
class TestEpisodeGeneratorForTraining:
    ...
    def test_to_training_sequences(self, generator: EpisodeGenerator) -> None:
    ...
    def test_training_sequences_targets_are_next_token(self, generator: EpisodeGenerator) -> None:
...
class TestDistributionTemperature:
    ...
    def test_temperature_point_five_improves_minority_coverage(self) -> None:
        ...
        stage_counts = dict.fromkeys(range(5), 0)
...
class TestMinimumStageCoverage:
    ...
    def test_min_coverage_enforced(self) -> None:
        ...
        stage_episode_count = dict.fromkeys(range(5), 0)
        for episode in episodes:
        ...
        assert (
            stage_episode_count[1] >= 0.2 * total
        ), f"Stage 1 coverage: {stage_episode_count[1] / total:.2f} < 0.20"
        assert (
            stage_episode_count[2] >= 0.2 * total
