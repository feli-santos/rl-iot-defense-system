...
\begin{document}
\begin{tikzpicture}[node distance=0.55cm and 1.05cm]
...
% ---- Group labels (anchored to the dashed boxes to avoid overlap) --
\node[groupLabel, above=2pt of gProc.north] {Offline preparation};
\node[groupLabel, below=2pt of gEnv.south] {Online environment};
