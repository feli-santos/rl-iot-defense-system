...
\begin{tikzpicture}[node distance=2.0cm]
  ...
  \node[attackBox] (attacker) {Tug-of-war\\attacker};
  ...
  \node[box, left=of stage, node distance=3.2cm, minimum width=3.2cm, minimum height=1.6cm, align=center] (kernel) {Tug-of-war\\kernel $P(s_{t+1}|s_t,a_t)$};
