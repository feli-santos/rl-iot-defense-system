...
> (`docs/results/04_detector/PLAN.md`). The PLAN is committed *before* any
...
(G3.4 in `docs/results/03_env/RESULTS.md` §4). That is the floor any
...
`docs/results/05_blue_team/F3_learning_curves.png` and
`F3_summary.json` with all numerical values cited in the caption.
...
locked in `T1_hparams.json`. **No sweeps in Phase 5.**
