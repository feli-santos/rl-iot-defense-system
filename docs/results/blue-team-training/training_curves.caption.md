...
PPO (blue), and A2C (green), each averaged across **10 seeds** with
...
`training_curves.json`; SHA-256 inputs/outputs in `training_curves_manifest.json`.
